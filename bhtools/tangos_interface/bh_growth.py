...
def collect_mdot(halo, bh_link):
	mdot_hist_list, time_list = halo.calculate_for_progenitors(bh_link+'.raw(BH_mdot_histogram)','t()')
	return mdot_hist_list, time_list

def trace_bh_galaxy(halo, bh_link_string):
	mdot_hist_list, time_list = collect_mdot(halo, bh_link_string)
